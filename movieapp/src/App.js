...
export default class App extends Component {
 ...
 favorie:[]
  ...
  movie = [
    ...
    {id:1,name:"batman",description:"Lorem Ipsum est un texte d'espace réservé ",rating:"*",categorie:"Documentary" ,img:cover1},
    {id:2,name:"superman",description:"Lorem Ipsum est un texte d'espace réservé",rating:"*",categorie:"Action",img:cover2 },
  ...
  return (
    <div className="App" >
      ...
      <Route  exact  path='/'>
          ...
          <div  ><Moviei  movie={this.movie} addFavorie={this.addFavorie} /></div> 
          </Route>
